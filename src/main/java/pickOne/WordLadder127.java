...
public class WordLadder127 {
    //too slow
    public int ladderLengthUsingAStar(String beginWord, String endWord, List<String> wordList) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(w.ladderLengthUsingAStar(b, e, wl));
        System.out.println(w.ladderLengthUsingAStar(b, e, wl2));
        System.out.println(w.ladderLengthUsingAStar(b3, e3, wl3));
